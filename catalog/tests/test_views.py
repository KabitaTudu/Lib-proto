...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        # Create two users
        test_user1 = User.objects.create_user(username='testuser1', password='nnffmsd')
        test_user2 = User.objects.create_user(username='testuser2', password='sdfasre')
    ...
    def test_logged_in_users_correct_template(self):
        login = self.client.login(username='testuser1', password='nnffmsd')
        response = self.client.get(reverse('my-borrowed'))
    ...
    def test_pages_ordered_by_due_date(self):
        ...
        self.assertEqual(str(response.context['user']), 'testuser1')
        # Check that we got the response "success"
        self.assertEqual(response.status_code, 200)
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_logged_in_with_permission_borrowed_book(self):
        login = self.client.login(username='testuser2', password='sdfasre')
    ...
    def test_HTTP404_for_invalid_book_if_logged_in(self):
        # unlikely UID to watch our bookinstance!
        test_uid = uuid.uuid4()
        login = self.client.login(username='testuser2', password='sdfasre')
...
class AuthorCreateViewTest(TestCase):
    """Test case for the author create view"""
